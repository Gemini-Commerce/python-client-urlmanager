...
class TestUrlRewriteLinkRel(unittest.TestCase):
    """UrlRewriteLinkRel unit test stubs"""
    ...
    def testUrlRewriteLinkRel(self):
        """Test UrlRewriteLinkRel"""
        # inst = UrlRewriteLinkRel()
