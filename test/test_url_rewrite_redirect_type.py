...
class TestUrlRewriteRedirectType(unittest.TestCase):
    """UrlRewriteRedirectType unit test stubs"""
    ...
    def testUrlRewriteRedirectType(self):
        """Test UrlRewriteRedirectType"""
        # inst = UrlRewriteRedirectType()
