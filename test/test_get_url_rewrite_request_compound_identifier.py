...
class TestGetUrlRewriteRequestCompoundIdentifier(unittest.TestCase):
    """GetUrlRewriteRequestCompoundIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUrlRewriteRequestCompoundIdentifier:
        """Test GetUrlRewriteRequestCompoundIdentifier
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUrlRewriteRequestCompoundIdentifier`
        """
        model = GetUrlRewriteRequestCompoundIdentifier()
        if include_optional:
            return GetUrlRewriteRequestCompoundIdentifier(
                context = '',
                request_path = ''
            )
        else:
    ...
    def testGetUrlRewriteRequestCompoundIdentifier(self):
        """Test GetUrlRewriteRequestCompoundIdentifier"""
