...
class TestUrlmanagerGetUrlRewriteRequest(unittest.TestCase):
    """UrlmanagerGetUrlRewriteRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UrlmanagerGetUrlRewriteRequest:
        """Test UrlmanagerGetUrlRewriteRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UrlmanagerGetUrlRewriteRequest`
        """
        model = UrlmanagerGetUrlRewriteRequest()
        if include_optional:
            return UrlmanagerGetUrlRewriteRequest(
                tenant_id = '',
                id = '',
                compound_identifier = urlmanager.models.get_url_rewrite_request_compound_identifier.GetUrlRewriteRequestCompoundIdentifier(
                    context = '', 
                    request_path = '', )
            )
        else:
    ...
    def testUrlmanagerGetUrlRewriteRequest(self):
        """Test UrlmanagerGetUrlRewriteRequest"""
