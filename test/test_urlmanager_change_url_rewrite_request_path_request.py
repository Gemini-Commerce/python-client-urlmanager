...
class TestUrlmanagerChangeUrlRewriteRequestPathRequest(unittest.TestCase):
    """UrlmanagerChangeUrlRewriteRequestPathRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UrlmanagerChangeUrlRewriteRequestPathRequest:
        """Test UrlmanagerChangeUrlRewriteRequestPathRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UrlmanagerChangeUrlRewriteRequestPathRequest`
        """
        model = UrlmanagerChangeUrlRewriteRequestPathRequest()
        if include_optional:
            return UrlmanagerChangeUrlRewriteRequestPathRequest(
                tenant_id = '',
                context = '',
                request_path = '',
                request_path_new = ''
    ...
    def testUrlmanagerChangeUrlRewriteRequestPathRequest(self):
        """Test UrlmanagerChangeUrlRewriteRequestPathRequest"""
