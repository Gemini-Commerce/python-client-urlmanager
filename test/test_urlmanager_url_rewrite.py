...
class TestUrlmanagerUrlRewrite(unittest.TestCase):
    """UrlmanagerUrlRewrite unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UrlmanagerUrlRewrite:
        """Test UrlmanagerUrlRewrite
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UrlmanagerUrlRewrite`
        """
        model = UrlmanagerUrlRewrite()
        if include_optional:
    ...
    def testUrlmanagerUrlRewrite(self):
        """Test UrlmanagerUrlRewrite"""
