...
class TestUrlmanagerResolveUrlRewriteRequest(unittest.TestCase):
    """UrlmanagerResolveUrlRewriteRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UrlmanagerResolveUrlRewriteRequest:
        """Test UrlmanagerResolveUrlRewriteRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UrlmanagerResolveUrlRewriteRequest`
        """
        model = UrlmanagerResolveUrlRewriteRequest()
        if include_optional:
            return UrlmanagerResolveUrlRewriteRequest(
                tenant_id = '',
                context = '',
                request_path = ''
            )
    ...
    def testUrlmanagerResolveUrlRewriteRequest(self):
        """Test UrlmanagerResolveUrlRewriteRequest"""
