...
class TestListUrlRewritesRequestFilter(unittest.TestCase):
    """ListUrlRewritesRequestFilter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListUrlRewritesRequestFilter:
        """Test ListUrlRewritesRequestFilter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListUrlRewritesRequestFilter`
        """
        model = ListUrlRewritesRequestFilter()
        if include_optional:
            return ListUrlRewritesRequestFilter(
                context = '',
                request_path = '',
                target_path = '',
    ...
    def testListUrlRewritesRequestFilter(self):
        """Test ListUrlRewritesRequestFilter"""
