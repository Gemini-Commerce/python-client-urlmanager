...
class TestUrlmanagerDeleteUrlRewriteRequest(unittest.TestCase):
    """UrlmanagerDeleteUrlRewriteRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UrlmanagerDeleteUrlRewriteRequest:
        """Test UrlmanagerDeleteUrlRewriteRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UrlmanagerDeleteUrlRewriteRequest`
        """
        model = UrlmanagerDeleteUrlRewriteRequest()
        if include_optional:
            return UrlmanagerDeleteUrlRewriteRequest(
                tenant_id = '',
                id = ''
            )
        else:
    ...
    def testUrlmanagerDeleteUrlRewriteRequest(self):
        """Test UrlmanagerDeleteUrlRewriteRequest"""
