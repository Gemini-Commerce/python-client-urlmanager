...
class TestUrlmanagerCreateUrlRewriteRequest(unittest.TestCase):
    """UrlmanagerCreateUrlRewriteRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UrlmanagerCreateUrlRewriteRequest:
        """Test UrlmanagerCreateUrlRewriteRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UrlmanagerCreateUrlRewriteRequest`
        """
        model = UrlmanagerCreateUrlRewriteRequest()
        if include_optional:
            return UrlmanagerCreateUrlRewriteRequest(
                tenant_id = '',
                context = '',
                request_path = '',
                target_path = '',
    ...
    def testUrlmanagerCreateUrlRewriteRequest(self):
        """Test UrlmanagerCreateUrlRewriteRequest"""
