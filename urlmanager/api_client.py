...
from urlmanager.api_response import ApiResponse, T as ApiResponseT
import urlmanager.models
from urlmanager import rest
from urlmanager.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(urlmanager.models, klass)
