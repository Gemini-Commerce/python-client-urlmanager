...
class UrlmanagerListUrlRewritesByTargetPathsRequest(BaseModel):
    """
    ...
    target_paths: Optional[List[StrictStr]] = Field(default=None, description="Required.", alias="targetPaths")
    context: Optional[StrictStr] = Field(default=None, description="Optional.")
    link_rel: Optional[UrlRewriteLinkRel] = Field(default=UrlRewriteLinkRel.UNKNOWN, alias="linkRel")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["tenantId", "targetPaths", "context", "linkRel"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UrlmanagerListUrlRewritesByTargetPathsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UrlmanagerListUrlRewritesByTargetPathsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "targetPaths": obj.get("targetPaths"),
