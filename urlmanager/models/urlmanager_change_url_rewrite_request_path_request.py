...
class UrlmanagerChangeUrlRewriteRequestPathRequest(BaseModel):
    """
    ...
    request_path_new: Optional[StrictStr] = Field(default=None, description="Required.", alias="requestPathNew")
    __properties: ClassVar[List[str]] = ["tenantId", "context", "requestPath", "requestPathNew"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UrlmanagerChangeUrlRewriteRequestPathRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UrlmanagerChangeUrlRewriteRequestPathRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "requestPathNew": obj.get("requestPathNew")
        })
        return _obj
