...
class UrlmanagerGetUrlRewriteRequest(BaseModel):
    """
    UrlmanagerGetUrlRewriteRequest
    """ # noqa: E501
    tenant_id: Optional[StrictStr] = Field(default=None, description="Required.", alias="tenantId")
    id: Optional[StrictStr] = None
    compound_identifier: Optional[GetUrlRewriteRequestCompoundIdentifier] = Field(default=None, alias="compoundIdentifier")
    __properties: ClassVar[List[str]] = ["tenantId", "id", "compoundIdentifier"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UrlmanagerGetUrlRewriteRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of compound_identifier
        if self.compound_identifier:
            _dict['compoundIdentifier'] = self.compound_identifier.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UrlmanagerGetUrlRewriteRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "compoundIdentifier": GetUrlRewriteRequestCompoundIdentifier.from_dict(obj.get("compoundIdentifier")) if obj.get("compoundIdentifier") is not None else None
        })
        return _obj
