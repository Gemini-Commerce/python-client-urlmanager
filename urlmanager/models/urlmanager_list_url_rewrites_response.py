...
class UrlmanagerListUrlRewritesResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["urlRewrites", "nextPageToken"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UrlmanagerListUrlRewritesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UrlmanagerListUrlRewritesResponse from a dict"""
        if obj is None:
            return None
